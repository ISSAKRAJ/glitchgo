...
result = response.json()`
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-emerald-500 selection:text-slate-950 relative overflow-hidden w-full">
      ...
      {/* PART 1: HERO SECTION */}
      <section className="max-w-6xl mx-auto px-6 pt-40 pb-16 text-center relative z-10">
          ...
          <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2 pt-2">
                ...
                <div className="font-mono text-xs bg-slate-950/80 border border-slate-800 p-4 rounded-xl text-zinc-300 overflow-x-auto min-h-20 flex items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-slate-900 border-2 border-emerald-500 p-6 rounded-2xl flex flex-col justify-between relative shadow-xl shadow-emerald-500/10">
            ...
            <div>
              ...
              <ul className="space-y-3 text-[10px] text-slate-355 mb-6">
            ...
            <a href="/portal" className="w-full bg-emerald-500 hover:bg-emerald-400 text-slate-950 text-center font-bold py-2.5 rounded-xl text-xs transition-all cursor-pointer">Claim MSME Tier</a>
          </div>
