...
result = response.json()`
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-emerald-500 selection:text-slate-950 relative w-full">
      {/* Cyber Grid Background Effect */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#0f172a_1px,transparent_1px),linear-gradient(to_bottom,#0f172a_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none" />

      {/* Glow Effects */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-emerald-500/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-red-500/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <section id="architecture" className="py-20 px-6 max-w-7xl mx-auto border-t border-slate-900 relative z-10">
      ...
      <section id="simulator" className="py-20 px-6 max-w-5xl mx-auto border-t border-slate-900 relative z-10">
      ...
      <section id="workflow" className="py-20 px-6 max-w-6xl mx-auto border-t border-slate-900 relative z-10">
        <div className="text-center mb-16">
      ...
      <section id="pricing" className="py-20 px-6 max-w-7xl mx-auto border-t border-slate-900 relative z-10">
        <div className="text-center mb-16">
