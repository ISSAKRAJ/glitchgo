...
const KB = {
  ...
  install: {
    ...
    reply: () => `**Integrating AdminZero is free — but requires a free account.**\n\n🔑 **Step 1:** Create your free account at **glitchgo.tech/signup**\n📥 **Step 2:** Your API License Key will appear in the **Client Portal** the moment you sign up\n🚀 **Step 3:** Use the key in your API requests:\n\nJust send a POST request to "https://glitchgo.onrender.com/api/v1/query" with your prompt and license key!\n\nSign up free → **glitchgo.tech/signup**`
  },
  pricing: {
    triggers: ['price', 'pricing', 'plan', 'cost', 'how much', 'free', 'paid', 'subscription', 'rupee', 'inr', '₹', 'startup', 'enterprise', 'scale', 'pro', 'team'],
    reply: () => `**AdminZero Flexible Compute-Credit Pricing:**\n\nWe use a **Compute Credit** system. Toggling security layers consumes credits dynamically per-request:\n• **Base Query Routing:** 1 Credit\n• **PII scrubbing:** +1 Credit\n• **Prompt Injection Scanner:** +1 Credit\n• **AST Guard (DROP/DELETE block):** +2 Credits\n*(A fully secured query consumes 5 Credits)*\n\n**Monthly Subscription Tiers:**\n🆓 **Developer** — ₹0 / forever\n• 10,000 Credits / month\n• Community Discord Support\n\n🚀 **Pro** — ₹1,999 / month\n• 500,000 Credits / month\n• Custom Query Blocklists & Multi-key management\n\n📈 **Team** — ₹9,999 / month\n• 3,000,000 Credits / month\n• Advanced Prompt Guard & Priority Slack Support\n\n🏢 **Enterprise** — Custom Quote\n• Unlimited credits & Private VPC Cloud deployment\n\n⚡ **Need more credits mid-cycle? Buy Top-Up Packs:**\n• **Starter Top-Up:** ₹99 for +15,000 credits\n• **Growth Top-Up:** ₹499 for +100,000 credits\n• **Scale Top-Up:** ₹1,999 for +500,000 credits`
  },
  database: {
