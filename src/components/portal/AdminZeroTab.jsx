    ...
    <div className="space-y-10">
      ...
      <Card className="bg-white/[0.01] border-white/5 p-6 text-left space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <a
            href={`https://slack.com/oauth/v2/authorize?client_id=11352040316962.11349992784470&scope=app_mentions:read,chat:write&redirect_uri=${encodeURIComponent(redirectUri)}`}
