...
// Returns sanitizedQuery — pass to Pinecone/Weaviate/ChromaDB`}</pre>
  ...
  body: JSON.stringify({
    ...
    mode: "passthrough"  // skip Gemini, treat as raw SQL
        ...
        <div className="bg-[#050505] border border-zinc-900 rounded-3xl p-6 md:p-8 space-y-6 shadow-2xl">
          <div>
            <span className="text-[10px] text-zinc-500 uppercase tracking-widest font-mono font-bold">Client Download Manager</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <a 
              ...
              target="_self"
              className="bg-zinc-950 hover:bg-zinc-900 border border-zinc-850 hover:border-brand-orange p-4 rounded-2xl text-center space-y-2 transition-all cursor-pointer group flex flex-col items-center justify-center"
            >
              <Monitor size={20} className="text-brand-orange mx-auto group-hover:scale-105 transition-transform" />
            ...
            <a 
              ...
              className="bg-zinc-950 hover:bg-zinc-900 border border-zinc-850 hover:border-brand-orange p-4 rounded-2xl text-center space-y-2 transition-all cursor-pointer group flex flex-col items-center justify-center"
            >
              <Terminal size={20} className="text-brand-orange mx-auto group-hover:scale-105 transition-transform" />
        ...
        <div className="bg-[#050505] border border-zinc-900 rounded-3xl p-6 md:p-8 space-y-6 shadow-2xl">
          <div>
            <span className="text-[10px] text-zinc-500 uppercase tracking-widest font-mono font-bold">Alternative deployment Options</span>
          ...
          {/* Tab Selector */}
          <div className="flex border-b border-zinc-900 font-mono text-xs font-semibold gap-4">
            <button 
              onClick={() => setActiveTab('docker')}
              className={`pb-2 border-b-2 cursor-pointer transition-colors border-none ${activeTab === 'docker' ? 'border-brand-orange text-white' : 'border-transparent text-zinc-500'}`}
            >
              Docker
            </button>
            <button 
              onClick={() => setActiveTab('cli')}
              className={`pb-2 border-b-2 cursor-pointer transition-colors border-none ${activeTab === 'cli' ? 'border-brand-orange text-white' : 'border-transparent text-zinc-500'}`}
            >
              CLI / Daemon
            </button>
          </div>
          ...
          {activeTab === 'docker' ? (
            <div className="space-y-4">
              ...
              <div className="bg-zinc-950 border border-zinc-900 p-4 rounded-xl font-mono text-[11px] text-indigo-300 overflow-x-auto leading-relaxed relative">
                <pre>
{`docker run -d \\
  -p 5001:5001 \\
  ...
  adminzero/agent:latest`}
            ...
            <div className="space-y-4">
              ...
              <div className="bg-zinc-950 border border-zinc-900 p-4 rounded-xl font-mono text-[11px] text-indigo-300 overflow-x-auto leading-relaxed relative space-y-3">
                <div>
                  <span className="text-zinc-500"># Install the proxy client</span>
                  <pre className="text-white mt-1">$ npm install -g @adminzero/agent</pre>
                </div>
                <hr className="border-zinc-850" />
                <div>
                  <span className="text-zinc-500"># Start local proxy engine</span>
